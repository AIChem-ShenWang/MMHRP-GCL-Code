    ...
    def __init__(self,
        ...
        if GraphEncoder is not None:
          ...
          self.ReaProEncoder = nn.Sequential(
            self.GATU_ReaPro,
            nn.Linear(self.GATU_OutSize, 128)
          )
        ...
        if TextEncoder is not None:
          ...
          self.bigru = BiGRU(bigru_input, bigru_hidden, bigru_num_layers, bigru_output, device)
        ...
        self.decoder = nn.Sequential(
            nn.Linear(emb_size, Decoder_Channels[0]),
            nn.ReLU(),
...
class MMHRP_Explanation(nn.Module):
    def __init__(self,
                 GraphEncoder: dict = None,
                 TextEncoder: dict = None,
                 Decoder:dict = None,
        ...
        super(MMHRP_Explanation, self).__init__()
        ...
        self.GATU_ReaPro = GATU(NodeFeatNum, GAT_Channels, GAT_Heads)
        self.GATU_CatSol = GATU(NodeFeatNum, GAT_Channels, GAT_Heads)
        self.ReaProLinear = nn.Linear(self.GATU_OutSize, 128)
        self.CatSolLinear = nn.Linear(self.GATU_OutSize, 128)
